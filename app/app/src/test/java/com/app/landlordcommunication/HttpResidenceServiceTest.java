...
public class HttpResidenceServiceTest {
    ...
    @InjectMocks
    HttpResidenceService mockResidenceService;

    private static List<Residence> mockResidenceList;
    ...
    @Test
    public void getResidencesByUser_getAllResidencesByGivenUserId() throws IOException {
        //Arrange
        ...
        //Act
        List<Residence> result = mockResidenceService.getResidencesByUser(1);
